...
csv_path = r"C:\Users\nizarg\OneDrive - Bjarke Ingels Group\Desktop\VPHIL\02 WIP\05 Scripts\BPD60_VLF_FACADE_LAYER TABLE.csv"
...
def override_dwg_layers(Layer_name, R, G, B, LW, LP_id):
    for cat in documentCategories:
        if cat.Name in ("BPD 100_ENV_Roof plans_Roof A.dwg", "BPD 100_ENV_Roof plans_Roof B.dwg", "BPD 100_ENV_Roof plans_Roof C.dwg", "BPD 100_ENV_Roof plans_Roof D.dwg", "BPD 100_ENV_Roof plans_Roof E.dwg"):
            print(cat.Name)
